...
- [Fechin/reference](https://github.com/Fechin/reference) (★7635 EJS) - Reference is a collaborative platform providing a comprehensive collection of cheat sheets for developers in various programming languages and tools.
- [FlowiseAI/Flowise](https://github.com/FlowiseAI/Flowise) (★36242 TypeScript) - Flowise is a user-friendly tool for building custom applications leveraging Large Language Models through a drag-and-drop interface.
...
- [LAION-AI/Open-Assistant](https://github.com/LAION-AI/Open-Assistant) (★37257 Python) - OpenAssistant is a chat-based AI assistant designed to understand and complete tasks while allowing dynamic interaction with third-party systems.
- [LiLittleCat/awesome-free-chatgpt](https://github.com/LiLittleCat/awesome-free-chatgpt) (★19552 Python) - An updated collection of free ChatGPT mirror sites that allows users to access GPT functionalities without account login.
...
- [RUCAIBox/LLMSurvey](https://github.com/RUCAIBox/LLMSurvey) (★11188 Python) - LLMSurvey is a comprehensive GitHub repository that aggregates research papers and resources dedicated to Large Language Models, supporting both academic and community-driven advancements in the field.
...
- [ai-boost/awesome-prompts](https://github.com/ai-boost/awesome-prompts) (★5838 ) - A curated collection of top-rated prompts for OpenAI's GPTs, fostering community sharing and advanced prompt engineering.
...
- [alecm20/story-flicks](https://github.com/alecm20/story-flicks) (★1414 Python) - Story Flicks allows users to generate high-definition story short videos effortlessly using AI models.
...
- [atfortes/Awesome-LLM-Reasoning](https://github.com/atfortes/Awesome-LLM-Reasoning) (★2789 ) - Awesome LLM Reasoning is a curated collection of research papers and resources designed to enhance the reasoning capabilities of Large Language Models.
...
- [bookfere/Ebook-Translator-Calibre-Plugin](https://github.com/bookfere/Ebook-Translator-Calibre-Plugin) (★1891 Python) - A Calibre plugin that enables translation of ebooks into specified languages using various translation engines.
...
- [f/awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts) (★121587 HTML) - A curated collection of prompts designed to enhance the interactive experience with ChatGPT and other AI language models.
...
- [friuns2/BlackFriday-GPTs-Prompts](https://github.com/friuns2/BlackFriday-GPTs-Prompts) (★6422 ) - A collection of free prompts for GPT that supports various applications without a subscription.
...
- [humanloop/awesome-chatgpt](https://github.com/humanloop/awesome-chatgpt) (★8217 ) - Awesome ChatGPT is a curated repository that provides a comprehensive collection of tools, resources, and applications related to ChatGPT and GPT-3.
...
- [ikaijua/Awesome-AITools](https://github.com/ikaijua/Awesome-AITools) (★4745 ) - Awesome AI Tools is a comprehensive repository of AI-related utilities categorized for user convenience, featuring tools for AI chat assistants, search engines, programming development, and multimedia creation.
- [infiniflow/ragflow](https://github.com/infiniflow/ragflow) (★44822 TypeScript) - RAGFlow is an open-source engine for Retrieval-Augmented Generation that enhances question-answering through deep document understanding.
...
- [langgptai/awesome-claude-prompts](https://github.com/langgptai/awesome-claude-prompts) (★2153 ) - Awesome Claude Prompts is a curated collection of prompts designed to enhance user interactions with the Claude AI model.
...
- [microsoft/promptflow](https://github.com/microsoft/promptflow) (★10089 Python) - Prompt Flow is a development tool suite that simplifies the creation and deployment of high-quality LLM applications.
...
- [mouredev/Hello-Python](https://github.com/mouredev/Hello-Python) (★28956 Python) - Hello-Python is a comprehensive course for beginners that teaches Python programming through extensive video lessons, practical projects, and insights into backend and frontend development.
...
- [nichtdax/awesome-totally-open-chatgpt](https://github.com/nichtdax/awesome-totally-open-chatgpt) (★4601 ) - A curated list of open-source alternatives to ChatGPT that highlights various instruction-following language models for chat.
...
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) (★62316 MDX) - The OpenAI Cookbook offers practical examples and guides for utilizing the OpenAI API effectively.
...
- [rasbt/LLMs-from-scratch](https://github.com/rasbt/LLMs-from-scratch) (★41967 Jupyter Notebook) - This project implements a ChatGPT-like large language model (LLM) from scratch in PyTorch, providing a step-by-step guide and educational resources through a companion book.
- [reorx/awesome-chatgpt-api](https://github.com/reorx/awesome-chatgpt-api) (★6100 Python) - Awesome ChatGPT API is a curated repository of applications and tools utilizing the ChatGPT API, allowing users to configure their own API keys for flexible and on-demand usage.
...
- [sindresorhus/awesome-chatgpt](https://github.com/sindresorhus/awesome-chatgpt) (★5438 ) - Awesome-chatgpt is a curated repository of tools and applications utilizing ChatGPT, aimed at enhancing user experience and exploring innovative use cases.
...
- [AI4Finance-Foundation/FinGPT](https://github.com/AI4Finance-Foundation/FinGPT) (★15243 Jupyter Notebook) - FinGPT is an open-source financial large language model designed to revolutionize financial analytics through lightweight adaptation and continuous updates.
...
- [Bin-Huang/chatbox](https://github.com/Bin-Huang/chatbox) (★33281 TypeScript) - Chatbox is a user-friendly desktop client application designed for efficient interaction with various AI models and LLMs.
- [ChatGPTNextWeb/NextChat](https://github.com/ChatGPTNextWeb/NextChat) (★81956 TypeScript) - NextChat is a lightweight, multi-platform AI assistant that offers a fast and customizable chat experience integrated with advanced AI technologies.
- [CodePhiliaX/Chat2DB](https://github.com/CodePhiliaX/Chat2DB) (★20652 Java) - Chat2DB is an AI-driven SQL client and reporting tool that simplifies database management and enhances productivity.
...
- [ai-shifu/ChatALL](https://github.com/ai-shifu/ChatALL) (★15633 JavaScript) - ChatALL is a multi-bot chat platform that enables users to engage with several AI language models simultaneously to discover the best responses.
- [dice2o/BingGPT](https://github.com/dice2o/BingGPT) (★9194 JavaScript) - BingGPT is a multi-platform desktop application that enables users to interact seamlessly with Bing's AI-powered chat.
...
- [getumbrel/llama-gpt](https://github.com/getumbrel/llama-gpt) (★10944 TypeScript) - LlamaGPT is a self-hosted, offline chatbot powered by Llama 2, focusing on privacy and supporting a variety of models including Code Llama.
...
- [johnbean393/Sidekick](https://github.com/johnbean393/Sidekick) (★2216 Swift) - Sidekick is a native macOS app that enables users to chat with a local LLM, retrieving information from their files, folders, and websites securely and offline.
...
- [lencx/ChatGPT](https://github.com/lencx/ChatGPT) (★53644 Rust) - ChatGPT Desktop Application is a cross-platform software that allows users to interact with the ChatGPT AI language model directly from their desktops.
...
- [purocean/yn](https://github.com/purocean/yn) (★5775 TypeScript) - Yank Note is a highly extensible Markdown editor that enhances productivity with features like version control, AI integration, and robust document encryption.
- [siyuan-note/siyuan](https://github.com/siyuan-note/siyuan) (★33192 TypeScript) - SiYuan is a privacy-first, self-hosted personal knowledge management software that offers advanced organizational features and a user-friendly Markdown editing experience.
...
- [tw93/Pake](https://github.com/tw93/Pake) (★36763 Rust) - Pake is a framework that turns any webpage into a lightweight desktop application using Rust.
...
- [voideditor/void](https://github.com/voideditor/void) (★10879 TypeScript) - Void is an open-source code editor developed as an alternative to Cursor, leveraging the capabilities of VSCode while fostering a collaborative community for contributions and improvements.
...
- [josStorer/chatGPTBox](https://github.com/josStorer/chatGPTBox) (★10419 JavaScript) - ChatGPT Box is a versatile browser extension that integrates ChatGPT for seamless AI interaction, page summarization, and dynamic tools across various platforms.
...
- [All-Hands-AI/OpenHands](https://github.com/All-Hands-AI/OpenHands) (★50577 Python) - OpenHands is an AI-powered platform designed to enhance software development by allowing users to engage with code and automation without extensive programming knowledge.
...
- [OptimalScale/LMFlow](https://github.com/OptimalScale/LMFlow) (★8375 Python) - LMFlow is an extensible toolkit designed for the finetuning and inference of large foundation models, making advanced machine learning technologies accessible to the community.
- [OvidijusParsiunas/deep-chat](https://github.com/OvidijusParsiunas/deep-chat) (★1904 TypeScript) - Deep Chat is a fully customizable AI chatbot component that easily integrates into websites, offering diverse features like API connectivity, Speech To Text, and file handling.
...
- [anse-app/chatgpt-demo](https://github.com/anse-app/chatgpt-demo) (★8019 TypeScript) - The ChatGPT-API Demo is a minimal web UI designed to showcase the functionality of OpenAI's GPT-3.5 Turbo API.
...
- [arc53/DocsGPT](https://github.com/arc53/DocsGPT) (★15440 TypeScript) - DocsGPT is an open-source generative AI tool that enables reliable and secure information retrieval from diverse knowledge sources, avoiding hallucinations.
...
- [casibase/casibase](https://github.com/casibase/casibase) (★3255 Go) - Casibase is an open-source enterprise-level AI knowledge base and agent management platform that supports various AI models and features an administrative UI for user management.
- [coaidev/coai](https://github.com/coaidev/coai) (★8067 TypeScript) - Chat Nio is a next-generation AI one-stop solution providing extensive features for internationalization and business interaction across multiple AI models.
- [danny-avila/LibreChat](https://github.com/danny-avila/LibreChat) (★23222 TypeScript) - LibreChat is an enhanced ChatGPT clone that integrates multiple AI models and features for a comprehensive AI-driven conversation experience.
...
- [guangzhengli/ChatFiles](https://github.com/guangzhengli/ChatFiles) (★3313 TypeScript) - ChatFiles is an AI-driven document chatbot that allows users to upload files and engage in conversations about their content.
- [h2oai/h2ogpt](https://github.com/h2oai/h2ogpt) (★11719 Python) - h2oGPT is an open-source project that enables private chat interactions with local GPT models, supporting extensive document handling and multimedia processing.
...
- [huggingface/chat-ui](https://github.com/huggingface/chat-ui) (★8403 TypeScript) - HuggingFace's Chat UI is an open-source codebase for building and deploying a chat interface powered by various open-source models.
...
- [khoj-ai/khoj](https://github.com/khoj-ai/khoj) (★26670 Python) - Khoj is a self-hostable personal AI application that integrates various language models to enhance information retrieval and automate tasks.
- [lobehub/lobe-chat](https://github.com/lobehub/lobe-chat) (★57697 TypeScript) - Lobe Chat is an open-source AI chat framework that supports multiple AI providers and offers a modern user interface for interactive conversations.
...
- [microsoft/autogen](https://github.com/microsoft/autogen) (★41493 Python) - AutoGen is a comprehensive framework for developing multi-agent AI applications that can function autonomously or collaboratively with humans.
...
- [mlc-ai/web-llm](https://github.com/mlc-ai/web-llm) (★14994 TypeScript) - WebLLM is a high-performance in-browser inference engine that enables real-time language model processing using hardware acceleration.
...
- [open-compass/opencompass](https://github.com/open-compass/opencompass) (★4923 Python) - OpenCompass is a platform designed for the evaluation of large language models using over 100 datasets.
- [pashpashpash/vault-ai](https://github.com/pashpashpash/vault-ai) (★3322 JavaScript) - OP Vault allows users to enhance ChatGPT with long-term memory capabilities by enabling the upload of custom knowledge bases and providing interactive Q&A functionality.
...
- [steven-tey/novel](https://github.com/steven-tey/novel) (★14158 TypeScript) - Novel is a Notion-style WYSIWYG editor that utilizes AI-powered autocompletions for an enhanced writing experience.
- [vercel/ai-chatbot](https://github.com/vercel/ai-chatbot) (★13999 TypeScript) - Vercel AI Chatbot is an open-source, hackable chatbot template built with Next.js and AI SDK by Vercel.
...
- [wasp-lang/open-saas](https://github.com/wasp-lang/open-saas) (★9822 TypeScript) - OpenSaaS is a free, open-source starter template for building SaaS applications using React and Node.js, designed for fast and efficient development.
...
- [xtekky/gpt4free](https://github.com/xtekky/gpt4free) (★63816 Python) - gpt4free is an innovative repository providing a proof of concept API for managing requests across multiple AI providers, showcasing versatile features for text and image generation.
...
- [Aider-AI/aider](https://github.com/Aider-AI/aider) (★29265 Python) - Aider is an AI-powered pair programming assistant that enhances coding productivity directly within your terminal.
- [OpenInterpreter/open-interpreter](https://github.com/OpenInterpreter/open-interpreter) (★58761 Python) - Open Interpreter is a natural language interface that enables users to interact with their computers and run code locally through a conversational terminal interface.
...
- [aandrew-me/tgpt](https://github.com/aandrew-me/tgpt) (★2399 Go) - Terminal GPT (tgpt) is a command-line tool that enables users to interact with AI chatbots directly in their terminal without the need for API keys.
...
- [gofireflyio/aiac](https://github.com/gofireflyio/aiac) (★3619 Go) - AIAC is a command-line tool and library that automates the generation of Infrastructure-as-Code templates and other configurations using AI-powered Large Language Model providers.
...
- [yamadashy/repomix](https://github.com/yamadashy/repomix) (★13122 TypeScript) - Repomix is a powerful tool for packaging entire repositories into AI-friendly formats for seamless integration with Large Language Models and AI applications.
...
- [continuedev/continue](https://github.com/continuedev/continue) (★24552 TypeScript) - Continue is an open-source platform that enables developers to create and use custom AI code assistants through extensions for popular IDEs like Visual Studio Code and JetBrains.
...
- [olimorris/codecompanion.nvim](https://github.com/olimorris/codecompanion.nvim) (★2770 Lua) - CodeCompanion.nvim is an AI-powered plugin for Neovim that enhances coding efficiency by connecting users to various Large Language Models.
...
- [run-llama/rags](https://github.com/run-llama/rags) (★6425 Python) - RAGs is a Streamlit application that enables users to create Retrieval-Augmented Generation pipelines through natural language interactions.
...
- [2noise/ChatTTS](https://github.com/2noise/ChatTTS) (★35100 Python) - ChatTTS is a cutting-edge generative speech model designed for natural and expressive text-to-speech synthesis in dialogue scenarios.
...
- [QuivrHQ/quivr](https://github.com/QuivrHQ/quivr) (★37532 Python) - Quivr is an opinionated RAG framework that enables easy integration of Generative AI in applications, supporting various LLMs and file types.
...
- [crmne/ruby_llm](https://github.com/crmne/ruby_llm) (★1081 Ruby) - RubyLLM is a Ruby library that simplifies working with AI by offering a unified API for interacting with multiple AI providers without complex configurations.
...
- [farizrahman4u/loopgpt](https://github.com/farizrahman4u/loopgpt) (★1448 Python) - L♾️pGPT is a modular Python framework that enhances the Auto-GPT experience with extensibility, ease of use, and powerful AI capabilities.
...
- [kyegomez/swarms](https://github.com/kyegomez/swarms) (★4714 Python) - Swarms is a production-ready multi-agent orchestration framework that enables efficient task management and scalability in enterprise environments.
...
- [langflow-ai/langflow](https://github.com/langflow-ai/langflow) (★51566 Python) - Langflow is a versatile platform for building and deploying AI-powered agents and workflows, featuring a visual builder and extensive API integration.
- [langroid/langroid](https://github.com/langroid/langroid) (★3154 Python) - Langroid is a Python framework that simplifies the development of LLM-powered applications using a Multi-Agent paradigm for effective collaborative problem-solving.
...
- [zilliztech/GPTCache](https://github.com/zilliztech/GPTCache) (★7455 Python) - GPTCache is a library that creates a semantic cache for large language model queries, significantly reducing API costs and improving response speeds.
- [zjunlp/EasyEdit](https://github.com/zjunlp/EasyEdit) (★2129 Jupyter Notebook) - EasyEdit is a user-friendly framework for knowledge editing in large language models.
...
- [xiangsx/gpt4free-ts](https://github.com/xiangsx/gpt4free-ts) (★7753 TypeScript) - A TypeScript-based project providing a free API for OpenAI's GPT-4, allowing users to engage with various AI models without cost.
...
- [gotzmann/llama.go](https://github.com/gotzmann/llama.go) (★1339 Go) - llama.go is a Golang implementation of the LLaMA library aimed at making large language models accessible without the need for expensive GPU clusters.
...
- [sashabaranov/go-openai](https://github.com/sashabaranov/go-openai) (★9738 Go) - Go OpenAI is an unofficial client library that facilitates interactions with OpenAI's APIs, including support for ChatGPT, DALL·E, and Whisper in Go applications.
...
- [kodu-ai/claude-coder](https://github.com/kodu-ai/claude-coder) (★1856 TypeScript) - Claude Coder is an AI-powered VSCode extension that helps transform coding ideas into real projects effortlessly.
...
- [mem0ai/mem0](https://github.com/mem0ai/mem0) (★26203 Python) - Mem0 is an intelligent memory layer for AI agents that enables personalized interactions by remembering user preferences and adapting over time.
...
- [TBXark/ChatGPT-Telegram-Workers](https://github.com/TBXark/ChatGPT-Telegram-Workers) (★3623 TypeScript) - ChatGPT-Telegram-Workers allows seamless deployment of Telegram ChatGPT bots on cloud platforms like Cloudflare Workers and Docker, with extensive customization and support for multiple AI services.
...
- [enricoros/big-AGI](https://github.com/enricoros/big-AGI) (★6218 TypeScript) - Big-AGI is an advanced AI suite offering a range of functionalities including multi-model chats, AI personas, code execution, and real-time voice interactions, designed to enhance productivity for professionals.
- [feder-cr/Jobs_Applier_AI_Agent_AIHawk](https://github.com/feder-cr/Jobs_Applier_AI_Agent_AIHawk) (★27609 Python) - Jobs_Applier_AI_Agent_AIHawk automates the job application process, helping job seekers apply for multiple jobs with ease using artificial intelligence.
...
- [gptme/gptme](https://github.com/gptme/gptme) (★3596 Python) - gptme is a versatile personal AI assistant designed for terminal use, capable of executing code, browsing the web, editing files, and processing visual data.
...
- [onyx-dot-app/onyx](https://github.com/onyx-dot-app/onyx) (★12402 Python) - Onyx is an open-source generative AI chat platform designed for teams, enabling them to access their unique knowledge and integrate it with over 40 connectors.
...
- [smol-ai/GodMode](https://github.com/smol-ai/GodMode) (★4245 TypeScript) - GodMode is an AI Chat Browser that allows users to quickly access multiple AI platforms like ChatGPT, Claude, and Bing using a simple keyboard shortcut.
...
- [npiv/chatblade](https://github.com/npiv/chatblade) (★2595 Python) - Chatblade is an adaptable command-line interface tool designed to facilitate efficient interactions with OpenAI's ChatGPT.
